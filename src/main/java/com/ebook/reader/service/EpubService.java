...
public class EpubService {
    ...
    /**
     * Convert EPUB chapter to styled HTML
     */
    public String convertToStyledHtml(String htmlContent, String theme, int fontSize, String basePath) {
        if (htmlContent == null || htmlContent.trim().isEmpty()) {
            htmlContent = "<p>No content available</p>";
        }

        String bgColor, textColor, linkColor, footnoteColor, footnoteBg;
        if (theme.equals("dark")) {
            bgColor = "#1e1e1e";
            textColor = "#e5e7eb";
            linkColor = "#60a5fa";
            footnoteColor = "#3b82f6";
            footnoteBg = "rgba(59, 130, 246, 0.15)";
        } else if (theme.equals("sepia")) {
            bgColor = "#faf4e8";
            textColor = "#3d2f1f";
            linkColor = "#8b6f47";
            footnoteColor = "#a0825c";
            footnoteBg = "rgba(160, 130, 92, 0.15)";
        } else {
            bgColor = "#ffffff";
            textColor = "#1f2937";
            linkColor = "#2563eb";
            footnoteColor = "#3b82f6";
            footnoteBg = "rgba(37, 99, 235, 0.1)";
        }

        String fontStack = "'Georgia', 'Times New Roman', serif";
        ...
        <head>
            ...
            <style>
                * { box-sizing: border-box; margin: 0; }
                ...
                aside, .footnote, .endnote, .note,
                [role="doc-endnote"], [role="doc-footnote"],
                div[id^="note"], div[id^="fn"], div[id*="foot"],
                li[id^="note"], li[id^="fn"],
                p[id^="note"], p[id^="fn"] {
                    font-size: 0.9em;
                    padding: 1em;
        ...
        """,
                bgColor, textColor, fontStack, fontSize, textColor,
                linkColor, footnoteColor, footnoteBg, footnoteBg,
                footnoteColor, linkColor,
                htmlContent);
    }
